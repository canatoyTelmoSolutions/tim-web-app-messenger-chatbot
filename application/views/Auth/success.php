	...
	<div class="max-w-[1200px] mx-auto p-2 md:p-0">
		<div class="mt-[50px] md:grid grid-cols-2 place-items-center">
			<div class="leading-none text-[#0E194F]">
				<div class="text-[50px] lg:text-[26px] mt-20">Congratulation your password has been change.
Please log in your account. </div>
...
<br><br>
               <div class="pt-2 pb-6">
				...
				<a href="<?php echo site_url('/login'); ?>" class="text-sm md:text-md text-white bg-[#0E194F] rounded-md py-2 md:py-3 px-4 md:px-6 w-fit hover:bg-slate-800 transition-all cursor-pointer">
					<span>Log in</span>	
				</a>
                </div>
			</div>
			...
			<div class="stage" >
				<img 
					src="<?php echo base_url('assets/images/1910.png'); ?>"
					alt=""
