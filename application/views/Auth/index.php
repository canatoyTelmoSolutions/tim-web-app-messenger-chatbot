...
<div class="grid grid-cols-[1fr_600px] flex " id="login-form">
    ...
    <div class=" grid place-items-center">
        <div class="px-10 w-[400px]">
            ...
            <div  class="w-full px-3 py-2 float-right outline-none rounded-md text-sm button cursor-pointer" id="show-registration-form">New here? Register.</div>
        </div>      
    </div>
</div>

<!-- Rgister -->
<div class="grid grid-cols-[1fr_1000px] flex"id="registration-form" style="display:none;">
    <div class=" grid place-items-center ">
        <div class=" pl-10 ">
        <div class="px-10 w-[400px]">
            <div class="">
    ...
    <div class="bg-[#0E194F] grid place-items-center  h-screen flex">
        <img src="/assets/images/login.svg" alt="" class="content-center pt-10  ">
    </div>
</div>
