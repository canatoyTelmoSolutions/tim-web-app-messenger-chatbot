            ...
            <div class="mt-5 bg-white p-4 rounded-md shadow-md">
                ...
                <div class="grid gap-x-6 gap-y-4">
                    ...
                    <div class="">
                        ...
                        <input type="number" name="number" maxlength="11" value="<?php echo set_value('number') ?>" placeholder="Mobile number" class="w-full px-3 py-2 bg-gray-200 outline-none rounded-md text-sm 
