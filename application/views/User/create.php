            ...
            <div class="mt-5 bg-white p-4 rounded-md shadow-md">
                ...
                <div class="grid gap-x-6 gap-y-4 p-5">
                    ...
                    <div class="">
                        ...
                        <input type="text" name="firstname" autocomplete="off" required value="<?php echo set_value('firstname') ?>" placeholder="First name" class="w-full px-3 py-2 bg-gray-200 outline-none rounded-md text-sm
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="">
                            ...
                            <input type="number" name="age" autocomplete="off" required value="<?php echo set_value('age') ?>" placeholder="Age" class="w-full px-3 py-2 bg-gray-200 outline-none rounded-md text-sm
                        ...
                        <div class="">
                            ...
                            <select id="" name="gender" required class="w-full px-3 py-2 bg-gray-200 outline-none rounded-md text-sm
                            <? if (form_error('gender')) echo 'form_error border border-pink-500'; ?>">
                                <option value="male" <? if (set_value('gender') == 'male') echo 'selected'; ?>>Male</option>
                                <option value="female" <? if (set_value('gender') == 'female') echo 'selected'; ?>>Female</option>
                                <option value="others" <? if (set_value('gender') == 'others') echo 'selected'; ?>>Others</option>
                            </select>
                    ...
                    <div class="">
                        ...
                        <input type="number" name="number" value="<?php echo set_value('number') ?>" placeholder="Mobile number" autocomplete="off" required class="w-full px-3 py-2 bg-gray-200 outline-none rounded-md text-sm 
                    ...
                    <div class="">
                        ...
                        <input type="text" name="address" value="<?php echo set_value('address') ?>" placeholder="Home address" autocomplete="off" required class="w-full px-3 py-2 bg-gray-200 outline-none rounded-md text-sm 
                    ...
                    <div class="">
                        ...
                        <input type="email" name="email" value="<?php echo set_value('email') ?>" placeholder="Email" autocomplete="off" required class="w-full px-3 py-2 bg-gray-200 outline-none rounded-md text-sm 
