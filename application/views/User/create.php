            ...
            <div class="mt-5 bg-white p-4 rounded-md shadow-md">
                ...
                <div class="grid gap-x-6 gap-y-4 p-5">
                    ...
                    <div class="">
                        ...
                        <? if (form_error('number')) echo 'form_error border border-pink-500'; ?>" maxlength="11" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
