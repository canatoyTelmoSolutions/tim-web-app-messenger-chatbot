        ...
        <div class="text-white">
            <div class="mt-10">
                ...
                <div class="mt-3 grid gap-2">
                    <div class="group relative grid grid-cols-[30px_1fr] items-center p-1 cursor-pointer hover:bg-[#212A64] rounded-md transition-all hover:p-2 hover:px-3 hover:shadow-md">
